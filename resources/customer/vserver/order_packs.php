...
include BASE_PATH.'app/manager/customer/vserver/order_pack.php';
?>
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <?php if($user->sessionExists($_COOKIE['session_token'])){ ?>
        ...
        <div class="text-center" style="margin-top: 50px; margin-bottom: 50px;">
            <h1 style="font-size: 70px;">Prepaid <b style="color: #9e2033;">LXC</b> vServer</h1>
            <hr style="width: 40%;">
            <h1>Miete dir jetzt Prepaid LXC vServer mit Arbor DDoS Protection</h1>
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <div class="row">
                ...
                <?php
                $SQL = $db->prepare("SELECT * FROM `vm_server_packs` WHERE `type` = 'normal'");
                $SQL->execute();
                if ($SQL->rowCount() != 0) {
                ...
                <div class="col-md-4">
                    <div class="card shadow mb-5">
                        ...
                        </svg><!--end::Svg Icon--></span> 1 TB Fair Use Traffic <i class="fas fa-check text-success"></i><br>
                        ...
                        </svg><!--end::Svg Icon--></span> OneClick-Installer (Mehr dazu <a target="_blank" href="https://red-host.eu/faq">hier</a>) <i class="fas fa-check text-success"></i><br>
