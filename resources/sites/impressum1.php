    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            ...
            <div class="card">
				...
				Björn Schleyer Einzelunternehmen<br>
				Darler Heide 92<br>
				...
				Telefax: +49 (0) 209 - 513 010 39<br-->
				E-Mail (Allgemein/Support): <a href="mailto:mail@red-host.eu">mail@red-host.eu</a><br>
				E-Mail (Payment/Rechnungen): <a href="mailto:payments@red-host.eu">payments@red-host.eu</a><br>
				E-Mail (Abuse): <a href="mailto:abuse@red-host.eu">abuse@red-host.eu</a><br>
				<br>
